...
func TestWorldShadeHit(t *testing.T) {
	...
	if !c.Equals(RGB(0.38066119, 0.4758265, 0.285496)) {
	...
	if !c.Equals(RGB(0.90498447, 0.90498447, 0.90498447)) {
...
func TestWorldColorAt(t *testing.T) {
	...
	if !c.Equals(RGB(0.38066119, 0.4758265, 0.2854959)) {
...
func TestWorldCameraRender(t *testing.T) {
	...
	if !canvas.FastPixelAt(5, 5).Equals(RGB(0.38066119, 0.4758265, 0.285496)) {
...
func TestWorldReflect(t *testing.T) {
	...
	if !c.Equals(RGB(0.19033232, 0.23791540, 0.14274924)) {
		t.Errorf("world reflect failed: %+v", c)
	}

	c = w.ShadeHit(ii, 1)

	if !c.Equals(RGB(0.87675771, 0.92434079, 0.82917463)) {
...
func TestWorldRefract(t *testing.T) {
	...
	if !c.Equals(RGB(0, 0.99888454, 0.04721945)) {
...
func TestWorldShadeHitWithRefract(t *testing.T) {
	...
	if !c.Equals(RGB(0.9364254, 0.6864254, 0.6864254)) {
