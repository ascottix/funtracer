...
func TestLightning(t *testing.T) {
	...
	test(Vector(0, 0, -1), Vector(0, 0, -1), NewPointLight(Point(0, 10, -10), White), Gray(0.7363961), "eye opposite surface, light offset 45°")

	test(Vector(0, -math.Sqrt(2)/2, -math.Sqrt(2)/2), Vector(0, 0, -1), NewPointLight(Point(0, 10, -10), White), Gray(1.6363961), "eye in the path of the reflection vector")
